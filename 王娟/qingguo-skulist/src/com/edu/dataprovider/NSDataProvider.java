...
public class NSDataProvider {
	...
	public  Object[][] getTxtData() throws IOException{
		return new  TxtDataProvider().getTxtUser("D:\\san\\zhen\\api-test-2018\\²âÊÔuser.txt");
	}
	...
	public Object[][] getExcelDada() throws IOException{
		return new ExcelDataProvider().getTestDataByExcel("D:\\\\san\\\\zhen\\\\api-test-2018\\Çà¹ûÉãÏñ»úÍøÒ³µÄµÇÂ¼ÕËºÅºÍÃÜÂë.xlsx","Sheet1");
	}
