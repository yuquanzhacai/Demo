...
def send_email(send_from,send_to,auth_code,att_file,server="smtp.qq.com"):
    subject = '最新的测试报告'
...
def send_report():
    send_f = "2798011643@qq.com"
    send_t = "2798011643@qq.com"
    auth_code="xkqebeljadukdcgg"
    files="E:\\PyCharm\\WORK\\QingGuo\\report"
